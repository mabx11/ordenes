  ...
  render(){
    return (
      <Card style={{ background: "#0085BD",padding: "2em", border: 'none' }}>
        <Card.Header style={{ textAlign: 'center', background: "#102444", borderRadius:"40px"}}>
          <Row style={{textAlign: 'center'}}> 
            <Col style={{textAlign: 'center'}}>
              <Typography style={{textAlign: 'center',color: "#D6EEEB"}} variant="h5">REGISTRO DE NUEVA ORDEN</Typography>
            </Col>
          ...
          <Form style={{ textAlign: "left" }}>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridOrder">
                <Form.Label><h5>Cod. Orden:</h5></Form.Label>
                <Form.Control style={{background: "#373737", color: "white"}} value="021221001" type="text" disabled="true" />
              </Form.Group>
  
              <Form.Group as={Col} controlId="formGridState">
                <Form.Label><h5>Paciente:</h5></Form.Label>
            ...
            <Row className="mb-3">
              ...
              <Form.Group as={Col} controlId="formGridState">
                <Form.Label><h5>Médico:</h5></Form.Label>
                <Form.Select defaultValue="Seleccione...">
                  <option>Seleccione...</option>
            ...
            <Form.Group style={{textAlign: 'center'}} >
              <Button style={{background: '#009665', border: 'none'}} type="submit">
                Guardar orden
              </Button>
              &nbsp;&nbsp;
              <Button style={{background: '#FF5F5F', border: 'none'}} type="reset">
                Cancelar
              </Button>
            </Form.Group>
          </Form>
